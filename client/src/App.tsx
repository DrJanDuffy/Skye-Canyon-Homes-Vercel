...
import BuyerAgentServices from "@/pages/services/buyer-agent-simple";
import FirstTimeBuyerServices from "@/pages/services/first-time-buyer-simple";
import LuxuryPropertyServices from "@/pages/services/luxury-properties-simple";
import NewConstructionServices from "@/pages/services/new-construction-simple";
