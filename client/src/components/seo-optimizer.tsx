    ...
    switch (location) {
      case '/':
        return {
          ...
          keywords: ['Skye Canyon homes', 'Las Vegas real estate', 'Dr. Jan Duffy', 'luxury homes', 'North Las Vegas', 'REALTOR']
        }
      
      case '/properties':
        return {
          title: title || "Skye Canyon Properties for Sale | Dr. Jan Duffy REALTOR®",
          description: description || "Browse exclusive Skye Canyon properties with Dr. Jan Duffy. Luxury homes, detailed listings, and expert guidance in North Las Vegas real estate.",
          keywords: ['Skye Canyon properties', 'homes for sale', 'Las Vegas listings', 'luxury real estate']
        }
      
      case '/about':
        return {
          title: title || "About Dr. Jan Duffy | Skye Canyon Real Estate Expert",
          description: description || "Meet Dr. Jan Duffy, your dedicated Skye Canyon real estate expert. Years of experience, local market expertise, and proven results in Las Vegas.",
          keywords: ['Dr. Jan Duffy', 'real estate agent', 'Skye Canyon expert', 'Las Vegas REALTOR']
        }
      
      case '/market-analysis':
        return {
          title: title || "Skye Canyon Market Analysis | Current Home Values & Trends",
          description: description || "Get the latest Skye Canyon market analysis from Dr. Jan Duffy. Current home values, market trends, and pricing insights for informed decisions.",
      ...
      default:
        return {
          title: title || baseTitle,
          description: description || baseDescription,
          keywords: keywords.length > 0 ? keywords : ['Skye Canyon', 'real estate', 'Dr. Jan Duffy']
        }
    }
  }
