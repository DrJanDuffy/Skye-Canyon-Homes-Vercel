...
export default function EnhancedStructuredData() {
  const businessSchema = {
    ...
    "expertise": {
      ...
      "description": "Exclusive specialization in Skye Canyon luxury properties with comprehensive market knowledge"
    }
  };
  ...
  const expertiseSchema = {
    ...
    "description": "Definitive expertise in Skye Canyon luxury homes, market analysis, and property valuations",
    "expert": {
      "@type": "Person",
      "name": "Dr. Jan Duffy",
