    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center bg-red-500 rounded-full px-4 py-2 mb-4">
            <span className="text-sm font-medium text-white">🔴 TESTING - CHANGES WORKING</span>
          </div>
