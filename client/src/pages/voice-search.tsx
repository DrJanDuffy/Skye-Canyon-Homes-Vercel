  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="voice search real estate, AI property search, voice activated search, Las Vegas homes, Skye Canyon properties" />
        <meta property="og:title" content="Voice Property Search | AI-Powered Real Estate | Dr. Jan Duffy" />
        <meta property="og:description" content="Revolutionary voice-activated property search powered by AI. Find your dream home in Skye Canyon and Las Vegas using natural language." />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 max-w-4xl mx-auto">
              <h2 className="text-lg font-semibold text-blue-900 mb-3">Try These Voice Commands:</h2>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm">
                    Use natural language to describe what you're looking for. No need for specific search terms.
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
