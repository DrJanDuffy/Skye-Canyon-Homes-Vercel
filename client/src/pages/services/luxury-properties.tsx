  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Certified Luxury Home Marketing Specialist with $50M+ in Skye Canyon transactions. 98% of list price results. Call (702) 500-1902." />
        <meta name="keywords" content="luxury homes Skye Canyon, luxury real estate Las Vegas, golf course homes, custom luxury properties, 89166 luxury homes" />
        ...
        <meta property="og:description" content="Certified Luxury Home Marketing Specialist with $50M+ in transactions and 98% of list price results." />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center">
                ...
                <p className="text-xl opacity-90 max-w-3xl mx-auto mb-8">
                  Certified Luxury Home Marketing Specialist with $50M+ in transactions since 2009. 98% of list price results.
                </p>
                <a 
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-gray-900">Certified Luxury Marketing</h3>
                  <p className="text-gray-600">Institute for Luxury Home Marketing certification with proven $50M+ transaction history.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-gray-900">Golf Course Estates</h3>
                  <p className="text-gray-600">Specialized expertise in Desert Highlands Golf Course properties and premium locations.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-gray-900">Custom Home Expertise</h3>
                  <p className="text-gray-600">Deep knowledge of luxury builders, architectural styles, and high-end finishes.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-gray-900">Elite Results</h3>
                  <p className="text-gray-600">Consistent 98% of list price achievement with average 21-day market time.</p>
                </div>
              </div>
