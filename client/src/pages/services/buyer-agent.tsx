  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Premier Skye Canyon buyer agent with 15+ years exclusive community expertise. Direct builder access, off-market properties, and expert negotiation. Call (702) 500-1902." />
        <meta name="keywords" content="Skye Canyon buyer agent, Las Vegas buyer agent, luxury home buyer agent, new construction buyer agent, 89166 realtor" />
        ...
        <meta property="og:description" content="Premier Skye Canyon buyer agent with 15+ years exclusive community expertise. Average client saves $15K+." />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center">
                ...
                <p className="text-xl opacity-90 max-w-3xl mx-auto mb-8">
                  15+ years exclusive Skye Canyon specialization with direct builder relationships and off-market access. Average client saves $15K+.
                </p>
                <a 
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-gray-900">Market Analysis & Property Search</h3>
                  <p className="text-gray-600">Exclusive access to off-market properties and comprehensive market analysis for informed decisions.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-gray-900">Expert Negotiation</h3>
                  <p className="text-gray-600">Skilled negotiation that averages $15K+ savings for clients with 15+ years of experience.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-gray-900">Builder Relationships</h3>
                  <p className="text-gray-600">Direct partnerships with Skye Canyon builders for priority access to new construction.</p>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold mb-3 text-gray-900">Transaction Management</h3>
                  <p className="text-gray-600">Complete transaction oversight from offer to closing with expert guidance throughout.</p>
                </div>
              </div>
